...
A Web App that displays a route from Lisbon to Algarve and the available [Charging Stations](https://tblx-daimler-trucks-and-buses.getsandbox.com/charging-stations) along the way ⚡
This app is written in Vanilla JavaScript. (I did not see the necessity of using a library/ framework for this small POC)
